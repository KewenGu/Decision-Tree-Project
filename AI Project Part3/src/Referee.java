...
public class Referee
{
	...
	static Player player1 = new ConnectNPlayer("Beep", 1, timeLimit); // you should create your own player class and use it here
	static Player player2 = new ConnectNPlayer("Boop", 2, timeLimit);
